...
**Not Available, because some attractions only opened and had visitors in 2022**
...
**need to have (,na.rm = TRUE) inside the mean() or median() brackets in order to omit the NA values**
...
**If the mean is much higher than the median it means that there are some very popular attractions in the top quartile that are increasing the mean, but this does not affect the median.**
